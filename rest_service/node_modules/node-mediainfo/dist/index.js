...
module.exports = function MediaInfo(path) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2: return [2 /*return*/, new Promise(function (resolve) {
                        ...
                        var size = fs_1.statSync(path).size;
                        ...
                        stream.on('close', function () {
                            var newstream = fs_1.createReadStream(path, {
                                highWaterMark: 1024 * 1024,
                                start: seekTo,//TODO: catch error if seekto is -1
                            });
