...
set TDP0=%~dp0
set ERLANG_HOME="%TDP0%..\..\..\"
echo Setting erlang home: %ERLANG_HOME%
set STAR=%*
...
echo ERL_CMD=%ERL_CMD%
echo RABBITMQ_START_RABBIT=%RABBITMQ_START_RABBIT%
echo RABBITMQ_CONFIG_ARG=%RABBITMQ_CONFIG_ARG%
echo RABBITMQ_GENERATED_CONFIG_ARG=%RABBITMQ_GENERATED_CONFIG_ARG%
echo RABBITMQ_NAME_TYPE=%RABBITMQ_NAME_TYPE%
echo RABBITMQ_NODENAME=%RABBITMQ_NODENAME%
echo RABBITMQ_IO_THREAD_POOL_SIZE=%RABBITMQ_IO_THREAD_POOL_SIZE%
echo RABBITMQ_DEFAULT_ALLOC_ARGS=%RABBITMQ_DEFAULT_ALLOC_ARGS%
...
echo SASL_ERROR_LOGGER=%SASL_ERROR_LOGGER%
echo RABBIT_LAGER_HANDLER=%RABBIT_LAGER_HANDLER%
echo RABBITMQ_LAGER_HANDLER_UPGRADE=%RABBITMQ_LAGER_HANDLER_UPGRADE%
