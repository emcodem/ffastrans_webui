              ...
              fs.exists(getChunkFilename(currentTestChunk, identifier), function(exists){
                if(exists){
                  ...
                  if(currentTestChunk>numberOfChunks) {
                    ...
                    //console.log("Finished upload, renaming FROM" +  path.join($.temporaryFolder,original_filename) + " TO "+ path.join($.temporaryFolder,filename))
                    //fs.rename( path.join($.temporaryFolder,original_filename),path.join($.temporaryFolder,filename));
                  } else {
                    // Recursion //TODO: this might be a bad idea, what if we have thousands of chunks, stack overflow?
                    testChunkExists();
                  }
                } else {
                  callback('partly_done', filename, original_filename, identifier);
                  console.log("__partly_done: " + filename + identifier)
                }
              });
            }
        testChunkExists();
