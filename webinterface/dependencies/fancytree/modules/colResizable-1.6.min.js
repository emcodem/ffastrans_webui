...
(function($){ 	
	...
	var syncGrips = function (t){	
		...
		if (syncGripsTimer)
			clearTimeout(syncGripsTimer)

		syncGripsTimer = window.setTimeout(function(){
	...
	*/
	...
	var syncCols = function(t,i,isOver){
			...
			let _drag = drag;
			syncColsTimer = setTimeout(function(){
				console.log("syncCols")
				var inc = _drag.x - _drag.l, c = t.c[i], c2 = t.c[i+1]; 	//what the hell is the scope of drag, it is not in this!	
				console.log("inc",inc)
